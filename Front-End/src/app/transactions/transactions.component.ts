...
export class TransactionsComponent implements OnInit {
  ...
  checkStatus(){
    if(this.customer.carddetails.cardstatus==0){
      return true;
    }else{
      return false;
    }
  ...
  onOrderConfirmed(){
    console.log(this.customer.carddetails.creditbalance);
    console.log(this.productDetails.productcost);
    console.log(this.customer.carddetails.cardstatus);
    console.log(this.checkBalence());
